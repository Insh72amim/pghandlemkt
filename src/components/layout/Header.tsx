    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <div className="hidden md:flex items-center gap-4">
            <a href="https://app.pghandle.in" className="text-sm font-semibold hover:text-primary">Log in</a>
            <Button href="https://cal.com/pghandle/demo" size="sm">Book Demo</Button>
        </div>
          ...
          >
            <nav className="flex flex-col p-6 gap-4">
              ...
              <div className="flex flex-col gap-3 mt-4">
                <Button href="https://app.pghandle.in" variant="outline" className="w-full">Log in</Button>
                <Button href="https://cal.com/pghandle/demo" className="w-full">Book Demo</Button>
              </div>
            </nav>
          </motion.div>
        )}
